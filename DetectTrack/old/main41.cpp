...
int main()
{
	...
	fps=fps-3;
	cout<<"fps = "<<fps<<endl;
	CvVideoWriter *twriter = cvCreateVideoWriter( "s1motion.track.avi", //name
        CV_FOURCC('X','V','I','D'),fps,ssize,3);
	CvVideoWriter *mwriter = cvCreateVideoWriter( "s1motion.avi", //name
        CV_FOURCC('X','V','I','D'),fps,ssize,3);
	...
	element1l=cvCreateStructuringElementEx(7,6.5,4,3,CV_SHAPE_RECT,0);
	element1s=cvCreateStructuringElementEx(6,4,3,2,CV_SHAPE_RECT,0);
	element2l=cvCreateStructuringElementEx(4,4,2,2,CV_SHAPE_RECT,0);
	element2s=cvCreateStructuringElementEx(4,4,2,2,CV_SHAPE_RECT,0);
	// open operation 
